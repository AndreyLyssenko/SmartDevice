...
var accordionButtons = document.querySelectorAll('.footer__accordion-button');
var accordionWrapper = document.querySelectorAll('.footer__list-wrapper');
var svgLink = 'img/sprite.svg#accordion-closed-ico';
var accordionTitles = [];
...
var openAccordion = function openAccordion(trigger) {
  trigger.addEventListener('click', function (evt) {
    var currentAccordionButton = evt.target.nextElementSibling;
    var currentAccordionActive = currentAccordionButton.nextElementSibling;
...
var popupContainer = document.querySelector('.popup__box');
